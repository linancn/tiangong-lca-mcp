...
lastReviewedNote: 'Reviewed for Issue #54: broker tests now call the in-memory raw store concurrently and require one live value, one miss, removal, expiry cleanup, and missing-handle denial.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
