...
lastReviewedNote: 'Reviewed for Issue #52: the canonical gate now includes offline OAuth broker discovery, PKCE, encrypted-state, audience, Origin, token-separation, rotation-race, and revocation assertions; live Dev and Production authorization remain separately recorded operational proofs.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
