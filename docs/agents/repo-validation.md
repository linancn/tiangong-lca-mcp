...
lastReviewedNote: 'Reviewed for Issue #56: package/Docker proof now binds version 0.1.1 and requires the packed production install to contain every OAuth broker runtime module before publish or ECS use.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
