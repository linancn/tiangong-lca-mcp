...
lastReviewedNote: 'Reviewed for Issue #66: MCP 0.1.3 release validation executes the packed global HTTP bin through its package-manager shim and requires a live `/health` response.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
