...
lastReviewedNote: 'Reviewed for Issue #62: Docker validation requires a no-provenance single ARM64 manifest, explicit patched-OpenSSL readback, one SHA-bearing build/push/scan/run tag, and a COMPLETE ECR scan with zero HIGH/CRITICAL.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
