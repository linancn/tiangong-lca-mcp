...
lastReviewedNote: 'Reviewed for Issue #58: Docker validation now requires shim-before-activation order, `/pnpm/bin` on OCI PATH, and a real no-cache Linux ARM64 build before ECR use.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
