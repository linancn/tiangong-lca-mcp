...
lastReviewedNote: 'Reviewed for Issue #64: dependency validation requires latest Node 24-compatible direct versions, a clean peer graph, TIDAS SDK 0.2 real cases, and a runtime-clean MCP 0.1.2 package.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
